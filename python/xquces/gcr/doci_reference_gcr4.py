...
from xquces.gcr.igcr3 import _default_pair_indices, _default_triple_indices
...
class GCR4DOCIReferenceAnsatz:
    base_ansatz: IGCR4Ansatz
...
@dataclass(frozen=True)
class GCR4DOCIReferenceParameterization:
    norb: int
    nocc: int
    base_parameterization: IGCR4SpinRestrictedParameterization | None = None

    @property
    def _base(self) -> IGCR4SpinRestrictedParameterization:
    ...
    def _zero_diagonal(self) -> IGCR4SpinRestrictedSpec:
        return IGCR4SpinRestrictedSpec(
            ...
            sigma_values=np.zeros(len(_default_sigma_indices(self.norb)), dtype=np.float64),
        )
    ...
    def _transfer_full_rotation_params(
        self,
        params: np.ndarray,
        previous_base: IGCR4SpinRestrictedParameterization,
    ...
    def ansatz_from_parameters(self, params: np.ndarray) -> GCR4DOCIReferenceAnsatz:
        ...
        return GCR4DOCIReferenceAnsatz(
    ...
    def parameters_from_ansatz(self, ansatz: GCR4DOCIReferenceAnsatz | IGCR4Ansatz) -> np.ndarray:
        if isinstance(ansatz, GCR4DOCIReferenceAnsatz):
    ...
    def transfer_parameters_from(
        ...
        previous_parameterization: "GCR4DOCIReferenceParameterization | IGCR4SpinRestrictedParameterization | None" = None,
        ...
        if isinstance(previous_parameterization, GCR4DOCIReferenceParameterization):
